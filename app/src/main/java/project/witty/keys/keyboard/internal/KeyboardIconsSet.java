...
public final class KeyboardIconsSet {
    ...
    public static final String NAME_CHATGPT_CTA = "enter_chatgpt_cta";
    public static final String NAME_YOUTUBE_CTA = "enter_youtube_cta";
    public static final String NAME_GOOGLE_CTA = "enter_google_cta";
    public static final String NAME_TRANSLATION_CTA = "enter_translation_cta";
    public static final String NAME_GRAMMAR_CTA = "enter_grammar_cta";
    public static final String NAME_TONALITY_CTA = "enter_tonality_cta";
    public static final String NAME_OCR_CTA = "enter_ocr_cta";
    ...
    private static final Object[] NAMES_AND_ATTR_IDS = {
            ...
            NAME_CHATGPT_CTA, R.styleable.Keyboard_iconChatGptKey,
            NAME_YOUTUBE_CTA, R.styleable.Keyboard_iconYoutubeKey,
            NAME_GOOGLE_CTA, R.styleable.Keyboard_iconGoogleKey,
            NAME_TRANSLATION_CTA, R.styleable.Keyboard_iconTranslationKey,
            NAME_GRAMMAR_CTA, R.styleable.Keyboard_iconGrammarKey,
            NAME_OCR_CTA, R.styleable.Keyboard_iconOcrKey,
            NAME_TONALITY_CTA, R.styleable.Keyboard_iconTonalityKey
    };
