...
public final class KeyboardCodesSet {
    ...
    private static final int[] DEFAULT = {
            ...
            Constants.CODE_CHATGPT_CTA,
            Constants.CODE_YOUTUBE_CTA,
            Constants.CODE_GOOGLE_CTA,
            Constants.CODE_TRANSLATION_CTA,
            Constants.CODE_GRAMMAR_CTA,
            Constants.CODE_TONALITY_CTA,
            Constants.CODE_OCR_CTA,
            Constants.CODE_SWITCH_EMOJI,
