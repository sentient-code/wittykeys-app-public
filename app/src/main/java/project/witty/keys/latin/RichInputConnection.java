...
import project.witty.keys.latin.common.UnicodeSurrogate;
import project.witty.keys.latin.settings.SpacingAndPunctuations;
import project.witty.keys.latin.utils.CapsModeUtils;
import project.witty.keys.latin.utils.DebugLogUtils;
...
public final class RichInputConnection {
    ...
    public void commitText(final CharSequence text, final int newCursorPosition) {
        android.util.Log.d("WK_KEYBOARD", "[COMMIT_TEXT] text='" + text + "' cursorPos=" + newCursorPosition);
    ...
    public String getCommitedText (){
        return mCommittedTextBeforeComposingText.toString();
    }
}
