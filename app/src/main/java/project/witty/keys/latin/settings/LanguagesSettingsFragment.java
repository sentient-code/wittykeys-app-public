...
import project.witty.keys.compat.MenuItemIconColorCompat;
...
import static project.witty.keys.latin.settings.SingleLanguageSettingsFragment.LOCALE_BUNDLE_KEY;
