...
public final class Constants {
     ...
     * {@link project.witty.keys.keyboard.KeyboardActionListener#onCustomRequest(int)}.
     */
     ...
     * {@link project.witty.keys.keyboard.internal.KeyboardCodesSet}.
     */
    ...
    public static final int CODE_CHATGPT_CTA = -7;
    ...
    public static final int CODE_YOUTUBE_CTA = -14;
    public static final int CODE_GOOGLE_CTA = -15;
    public static final int CODE_TRANSLATION_CTA = -16;
    public static final int CODE_GRAMMAR_CTA = -17;
    public static final int CODE_TONALITY_CTA = -18;
    public static final int CODE_OCR_CTA = -19;
    public static final int CODE_SWITCH_EMOJI = -20;
    ...
    public static String printableCode(final int code) {
        switch (code) {
            ...
            case CODE_SPACE:
                return "space";
            case CODE_CHATGPT_CTA:
                return "chatGptCta";
            case CODE_YOUTUBE_CTA:
                return "youtubeCta";
            case CODE_GOOGLE_CTA:
                return "googleCta";
            case CODE_TRANSLATION_CTA:
                return "translationCta";
            case CODE_GRAMMAR_CTA:
                return "grammarCta";
            case CODE_TONALITY_CTA:
                return "tonalityCta";
            case CODE_OCR_CTA:
                return "ocrCta";
            case CODE_SWITCH_EMOJI:
                return "emoji";
            default:
     ...
     * {@link project.witty.keys.R.integer#config_screen_metrics}.
     */
