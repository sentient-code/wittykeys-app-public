...
import project.witty.keys.latin.common.LocaleUtils;
import project.witty.keys.latin.settings.Settings;
import project.witty.keys.latin.utils.SubtypePreferenceUtils;
...
public class RichInputMethodManager {
     ...
     */
    public List<SubtypeInfo> getEnabledSubtypeInfoOfAllImes(final Context context) {
     ...
     */
    public void switchToTargetIme(final String imiId, final InputMethodSubtype subtype,
